...
export const useBrandTheme = () => {
  ...
  return {
    // Couleurs de marque
    primaryColor: context.theme?.customColors.primary || '#d4dbe8',
    ...
    getButtonStyle: (variant: 'primary' | 'secondary' = 'primary') => ({
      backgroundColor: variant === 'primary' 
        ? context.theme?.customColors.primary || '#d4dbe8'
        : context.theme?.customColors.secondary || '#dc2626',
      color: context.theme?.customColors.text || '#ffffff',
      borderColor: context.theme?.customColors.primary || '#d4dbe8'
    }),
    ...
    primaryBg: `bg-[${context.theme?.customColors.primary || '#d4dbe8'}]`,
    primaryText: `text-[${context.theme?.customColors.primary || '#d4dbe8'}]`,
    primaryBorder: `border-[${context.theme?.customColors.primary || '#d4dbe8'}]`,
