        ...
        actions={
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 bg-[#E0004D] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#6d154d] transition-colors"
            >
        ...
        {!loading && !error && (
          <div className="bg-white rounded-xl shadow-sm mt-6">
            {selectedCampaigns.length > 0 && (
              <div className="p-4 bg-[#E0004D] text-white flex items-center justify-between">
                <span className="font-medium">
                  {selectedCampaigns.length} campagne(s) sélectionnée(s)
                </span>
                <button
                  onClick={handleDeleteSelected}
                  className="flex items-center gap-2 bg-white text-[#E0004D] px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition-colors"
                >
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            >
                              ...
                              />
                              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#E0004D]/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-gradient-to-br peer-checked:from-[#E0004D] peer-checked:to-[#6B2AA0]"></div>
                            </label>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <button
                            ...
                            className="p-2 text-gray-500 hover:text-[#E0004D] rounded-lg hover:bg-gray-100 transition-colors duration-200 relative"
                          >
