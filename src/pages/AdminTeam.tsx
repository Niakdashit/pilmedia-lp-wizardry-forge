      ...
      <div className="px-6">
        <div className="bg-white rounded-xl shadow-sm p-8">
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Gestion de l'Équipe</h3>
            <p className="text-gray-500 mb-6">
              Gestion des membres de l'équipe, attribution des rôles<br />
              et configuration des permissions d'accès.
            </p>
