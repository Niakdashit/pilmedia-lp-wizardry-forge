        ...
        actions={
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-2">
            <select
              ...
              className="w-full sm:w-auto bg-white border border-gray-300 text-gray-700 py-2 px-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#44444d]"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <div className="flex justify-between items-start">
              ...
              <div className="bg-[#f8f0f5] p-3 rounded-lg">
                <Users className="w-6 h-6 text-[#44444d]" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <div className="flex justify-between items-start">
              ...
              <div className="bg-[#f8f0f5] p-3 rounded-lg">
                <ArrowUpRight className="w-6 h-6 text-[#44444d]" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <div className="flex justify-between items-start">
              ...
              <div className="bg-[#f8f0f5] p-3 rounded-lg">
                <Target className="w-6 h-6 text-[#44444d]" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <div className="flex justify-between items-start">
              ...
              <div className="bg-[#f8f0f5] p-3 rounded-lg">
                <Calendar className="w-6 h-6 text-[#44444d]" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm lg:col-span-2">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex space-x-2">
                <button className="px-3 py-1.5 text-sm rounded-xl bg-gradient-to-br from-[#44444d] to-[#44444d] text-white border border-white/20 shadow shadow-[#44444d]/20">Participants</button>
            ...
            <div className="mt-6 space-y-3">
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  <div className="w-3 h-3 rounded-full bg-gradient-to-br from-[#44444d] to-[#44444d] mr-2"></div>
              ...
              conversion: '38%'
                ...
                <div key={index} className="flex items-center p-3 border border-gray-100 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                  <div className="w-10 h-10 rounded-lg bg-[#f8f0f5] flex items-center justify-center mr-4">
                    <Target className="w-5 h-5 text-[#44444d]" />
                  </div>
