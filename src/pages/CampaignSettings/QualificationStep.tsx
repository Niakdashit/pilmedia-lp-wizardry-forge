...
const QualificationStep: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-xl font-semibold font-brand text-primary-800">Qualification</h1>
      ...
      <div className="flex items-center justify-end gap-2">
        <button onClick={() => navigate('form')} className="px-3 py-1.5 border border-primary-200 rounded-lg text-sm text-primary-700 hover:bg-primary-50">Précédent</button>
