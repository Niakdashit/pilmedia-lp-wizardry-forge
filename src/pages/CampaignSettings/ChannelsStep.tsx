    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block text-sm text-gray-600 mb-1">Date et heure de début</label>
            <input
              type="datetime-local"
              value={(form.publication as any)?.start || ''}
              onChange={e => handleChange('publication.start', e.target.value)}
          ...
          <div>
            <label className="block text-sm text-gray-600 mb-1">Date et heure de fin</label>
            <input
              type="datetime-local"
              value={(form.publication as any)?.end || ''}
              onChange={e => handleChange('publication.end', e.target.value)}
              className="w-full px-3 py-2 border border-primary-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand"
            />
          </div>
        </div>
