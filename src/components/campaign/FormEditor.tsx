...
const FormEditor: React.FC<FormEditorProps> = ({
  ...
  return (
    <div className="h-[calc(150vh-3rem)] flex flex-col my-[24px] mx-[21px]">
      <div className="bg-[#f5f5f7] border border-[#d0d0d5] rounded-lg p-4 mb-6">
        <p className="text-[#44444d] text-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            ...
            <button onClick={addField} className="flex items-center gap-2 bg-gradient-to-br from-[#44444d] to-[#44444d] text-white px-4 py-2 rounded-lg hover:bg-[#6d1550] transition-colors">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#44444d]"
