      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-gradient-to-br from-[#d4dbe8] to-[#b41b60] text-white px-4 py-2 rounded-lg hover:bg-[#6d1550] disabled:opacity-50 disabled:cursor-not-allowed"
          >
              ...
              <div key={participation.id} className="p-4 hover:bg-gray-50">
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 text-[#d4dbe8] hover:bg-gradient-to-br hover:from-[#d4dbe8] hover:to-[#b41b60] hover:text-white px-3 py-1 rounded transition-colors"
                  >
