...
export const SettingsTab: React.FC = () => {
      ...
      setGeneratedContent(`
        <div style="max-width:600px;margin:0 auto;padding:20px;">
          ...
          <div style="margin:20px 0;">
            <a href="#" style="background:#E0004D;color:white;padding:10px 20px;text-decoration:none;border-radius:5px;">
              Call to Action
            </a>
          </div>
        </div>
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-semibold text-[#E0004D] mb-4 flex items-center">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full px-4 py-2 bg-gradient-to-br from-[#E0004D] to-[#6B2AA0] text-white rounded-lg"
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between flex-wrap gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-br from-[#E0004D] to-[#6B2AA0] text-white rounded-lg"
                >
      ...
      {showPreview && (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
          <div className="bg-white w-[90%] max-w-3xl rounded-lg shadow-lg p-6 relative overflow-auto max-h-[90vh]">
            ...
            <h3 className="text-lg font-bold mb-4 text-[#E0004D]">Aperçu de la newsletter</h3>
