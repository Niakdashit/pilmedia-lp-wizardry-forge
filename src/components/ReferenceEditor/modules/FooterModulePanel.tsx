...
const FooterModulePanel: React.FC<FooterModulePanelProps> = ({ module, onUpdate, onBack }) => {
  ...
  const linkColor = module.linkColor ?? '#44444d';
      ...
      <div className="flex gap-1 border-b border-gray-200">
        <button
          ...
          className={`px-3 py-2 text-sm font-medium transition-colors ${
            activeTab === 'text'
              ? 'border-b-2 border-[#44444d] text-[#44444d]'
          ...
          <>
            <div>
              ...
              <textarea
                ...
                className="mt-1 w-full min-h-[80px] px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#44444d] text-sm"
              />
            </div>
