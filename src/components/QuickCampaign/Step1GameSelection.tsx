      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 md:p-12">
          ...
          <div className="text-center mb-16">
            ...
            opacity: 1,
            y: 0
          }} className="mb-4 text-[#44444d] text-4xl font-semibold">
              Créer une campagne
            </motion.h1>
            <motion.p initial={{
            opacity: 0,
            ...
            delay: 0.1
          }} className="text-xl font-light text-[#5a5a63]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            ...
            return <motion.div key={game.id} initial={{
              ...
              delay: index * 0.1
                    ...
                    ${isSelected ? 'border-[#44444d] bg-gradient-to-br from-[#44444d]/5 to-[#44444d]/5 shadow-xl' : 'border-gray-200 bg-gray-50 hover:border-[#44444d]/50 hover:shadow-lg'}
                  `}>
                  {game.popular && <div className="absolute -top-3 -right-3 bg-gradient-to-br from-[#44444d] to-[#44444d] text-white text-xs px-3 py-1 rounded-full font-medium">
                      Populaire
                    </div>}
                  ...
                  <div className="text-center">
                    <div className={`
                      ...
                      ${isSelected ? 'bg-gradient-to-br from-[#44444d] to-[#44444d]' : 'bg-gray-100'}
                    `}>
          ...
          <div className="flex justify-between items-center">
            ...
            <button onClick={handleNext} disabled={!selectedGameType} className={`
                ...
                ${selectedGameType ? 'bg-gradient-to-br from-[#44444d] to-[#44444d] text-white hover:bg-[#44444d]/90 shadow-lg' : 'bg-gray-100 text-gray-400 cursor-not-allowed'}
              `}>
              <span>Continuer</span>
          ...
          <div className="text-center mt-16">
            <div className="flex items-center justify-center space-x-2 mb-4">
              <div className="w-8 h-1 bg-gradient-to-br from-[#44444d] to-[#44444d] rounded-full"></div>
