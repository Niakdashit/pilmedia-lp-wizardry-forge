      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 md:p-12">
          ...
          <div className="text-center mb-16">
            <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-4xl mb-4 text-[#44444d] font-semibold">
              Paramètres essentiels
            </motion.h1>
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-xl font-light text-[#5a5a63]/[0.78]">
          ...
          <div className="space-y-12">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
              ...
              <input
                ...
                className="w-full px-6 py-4 border-2 border-gray-200 rounded-2xl focus:border-[#44444d] focus:outline-none transition-all text-lg bg-gray-50"
              />
            </motion.div>
                    ...
                    {backgroundImage ? (
                      ...
                      <>
                        <p className="text-gray-600 mb-2 text-sm">
                          <span className="text-[#44444d] font-medium">Téléchargez une image</span>
                        </p>
          ...
          <div className="flex justify-between items-center mt-16">
            ...
            <button
              ...
              className={`
                ...
                ${canProceed ? 'bg-gradient-to-br from-[#44444d] to-[#44444d] text-white hover:bg-[#44444d]/90 shadow-lg' : 'bg-gray-100 text-gray-400 cursor-not-allowed'}
              `}
            >
              <span>Continuer</span>
