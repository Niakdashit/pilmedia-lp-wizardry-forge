          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={`flex flex-col items-center px-2 py-3 rounded-xl transition-all duration-200 group ${isActive ? 'bg-gradient-to-br from-[#E0004D] to-[#6B2AA0] text-white' : 'text-gray-300 hover:bg-gray-700/50 hover:text-white'}`}
              >
