...
const MobileTabRoulette: React.FC<MobileTabRouletteProps> = ({
  ...
  const [borderColor, setBorderColor] = useState<string>(mobileRouletteConfig.borderColor || '#E0004D');
  const [pointerColor, setPointerColor] = useState<string>(mobileRouletteConfig.pointerColor || '#E0004D');
