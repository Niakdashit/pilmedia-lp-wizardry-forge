      ...
      <div className="space-y-4 bg-white p-6 rounded-lg border">
        ...
        <div>
          ...
          <input
            ...
            className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-[#44444d] file:text-white hover:file:bg-[#6d164f]"
          />
        ...
        <div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <input
              ...
              value={gameConfig.buttonColor || '#ec4899'}
              onChange={(e) => handleInputChange('buttonColor', e.target.value)}
              className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#44444d]"
              placeholder="#ec4899"
            />
          </div>
        </div>
