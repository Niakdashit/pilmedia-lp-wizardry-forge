...
const TabRoulette: React.FC<TabRouletteProps> = ({
  ...
  const [borderColor, setBorderColor] = useState<string>('#44444d');
  const [pointerColor, setPointerColor] = useState<string>('#44444d');
