...
const EditableText: React.FC<EditableTextProps> = ({
  ...
  const resolvedTitleStyle = useMemo(() => ({
    fontSize: titleStyle?.fontSize || '2rem',
    ...
    lineHeight: titleStyle?.lineHeight || '1.4',
  }), [titleStyle]);

  const resolvedDescriptionStyle = useMemo(() => ({
    fontSize: descriptionStyle?.fontSize || '1rem',
    color: descriptionStyle?.color || '#4b5563',
    fontFamily: descriptionStyle?.fontFamily || 'inherit',
    textAlign: descriptionStyle?.textAlign || 'center',
    lineHeight: descriptionStyle?.lineHeight || '1.75',
    fontWeight: descriptionStyle?.fontWeight || 'normal',
  }), [descriptionStyle]);

  const typographyVars = useMemo(() => {
    const vars: React.CSSProperties = {};
    vars['--article-title-font-size' as any] = resolvedTitleStyle.fontSize;
    vars['--article-title-font-weight' as any] = resolvedTitleStyle.fontWeight;
    vars['--article-title-color' as any] = resolvedTitleStyle.color;
    vars['--article-title-font-family' as any] = resolvedTitleStyle.fontFamily;
    vars['--article-title-text-align' as any] = resolvedTitleStyle.textAlign;
    vars['--article-title-line-height' as any] = resolvedTitleStyle.lineHeight;
    vars['--article-description-font-size' as any] = resolvedDescriptionStyle.fontSize;
    vars['--article-description-color' as any] = resolvedDescriptionStyle.color;
    vars['--article-description-font-family' as any] = resolvedDescriptionStyle.fontFamily;
    vars['--article-description-text-align' as any] = resolvedDescriptionStyle.textAlign;
    vars['--article-description-line-height' as any] = resolvedDescriptionStyle.lineHeight;
    vars['--article-description-font-weight' as any] = resolvedDescriptionStyle.fontWeight;
    return vars;
  }, [resolvedTitleStyle, resolvedDescriptionStyle]);
    ...
    >
      ...
      {isSourceMode ? (
        ...
        <div
          ...
          style={{ 
            direction: 'ltr', 
            textAlign: resolvedDescriptionStyle.textAlign
          }}
        />
      ) : (
        <div
      ...
      <style>{`
        ...
        .article-text-content h2 {
          font-size: var(--article-title-font-size, 2rem);
          font-weight: var(--article-title-font-weight, bold);
          line-height: var(--article-title-line-height, 1.4);
          margin-top: 0;
          margin-bottom: 0.5em;
          color: var(--article-title-color, #1f2937);
          text-align: var(--article-title-text-align, center);
          font-family: var(--article-title-font-family, inherit);
        }
        [contenteditable] h2:not(:first-child),
        .article-text-content h2:not(:first-child) {
          margin-top: 0.75em;
        }
        [contenteditable] h3 {
          font-size: 1.25rem;
        ...
        .article-text-content p {
          font-size: var(--article-description-font-size, 1rem);
          line-height: var(--article-description-line-height, 1.75);
          margin-top: 0;
          margin-bottom: 0.5em;
          color: var(--article-description-color, #4b5563);
          text-align: var(--article-description-text-align, center);
          font-family: var(--article-description-font-family, inherit);
          font-weight: var(--article-description-font-weight, normal);
        }
        [contenteditable] p:not(:first-child),
        .article-text-content p:not(:first-child) {
          margin-top: 0.5em;
        }
