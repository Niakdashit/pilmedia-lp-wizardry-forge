              ...
              >
                ...
                <div className="flex items-center justify-center gap-3">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-[#E0004D] hover:bg-[#a0246e] text-white rounded text-sm font-medium"
                  >
                    OK
                  </button>
                </div>
        ...
        <div className="fixed inset-0 flex items-end justify-center pb-16 z-[200]" onClick={() => setShowLinkModal(false)}>
          <div className="bg-white border border-gray-300 rounded-md p-5 w-96 shadow-2xl max-h-[80vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-white border border-[#E0004D] rounded text-gray-900 text-sm focus:outline-none focus:border-[#a0246e]"
              placeholder="https://..."
              autoFocus
            />
            ...
            <div className="mt-4 space-y-2">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 text-[#E0004D] focus:ring-[#E0004D]"
                />
            ...
            <div className="flex justify-end gap-2 mt-5">
              <button
                ...
                className="px-4 py-1.5 text-[#E0004D] hover:text-[#a0246e] text-sm font-medium"
              >
                Annuler
              </button>
              <button
                ...
                className="px-5 py-1.5 bg-[#E0004D] hover:bg-[#a0246e] text-white rounded text-sm font-medium"
              >
                OK
              </button>
            </div>
            ...
            {imageInputMode === 'url' ? (
              ...
              <div className="mt-3">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-white border border-[#E0004D] rounded text-gray-900 text-sm focus:outline-none focus:border-[#a0246e] file:mr-3 file:py-1 file:px-3 file:rounded file:border-0 file:text-sm file:font-medium file:bg-[#E0004D] file:text-white hover:file:bg-[#a0246e]"
                />
                {imageFile && (
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-10 bg-white border border-[#E0004D] rounded cursor-pointer"
                  />
                </div>
              </div>
