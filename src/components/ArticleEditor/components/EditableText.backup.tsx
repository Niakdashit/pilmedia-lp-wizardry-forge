          ...
          <div className="relative">
            {isSourceMode ? (
              <textarea
                ...
                className={`w-full text-base text-gray-700 leading-relaxed bg-white border-2 border-[#44444d] rounded-lg p-3 resize-none focus:outline-none focus:ring-2 focus:ring-[#44444d] focus:ring-opacity-50 text-left ${descriptionClassName}`}
                dir="ltr"
                rows={10}
              ...
              <div
                ...
                className={`w-full min-h-[220px] text-base text-gray-700 leading-relaxed bg-white border-2 border-[#44444d] rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-[#44444d] focus:ring-opacity-50 text-left ${descriptionClassName}`}
                dir="ltr"
              />
            )}
