      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#E0004D] focus:border-transparent"
            placeholder="SPIN"
          />
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              value={buttonBorderColor}
              onChange={(e) => updateButtonBorderColor(e.target.value)}
              className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#E0004D] focus:border-transparent"
            />
          </div>
        </div>
