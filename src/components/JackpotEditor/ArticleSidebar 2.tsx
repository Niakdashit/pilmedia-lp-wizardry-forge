        ...
        <div className="space-y-3">
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                type="color"
                value={articleConfig.cta?.backgroundColor || '#44444d'}
                onChange={(e) => onArticleConfigChange({
              ...
              <input
                ...
                className="flex-1 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#44444d]"
                placeholder="#44444d"
              />
            </div>
          </div>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                type="color"
                value={articleConfig.cta?.borderColor || '#44444d'}
                onChange={(e) => onArticleConfigChange({
              ...
              <input
                ...
                className="flex-1 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#44444d] disabled:opacity-50 disabled:cursor-not-allowed"
                placeholder="#44444d"
                disabled={!articleConfig.cta?.borderWidth}
              />
            </div>
