    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-100 p-8">
        <ArticleCanvas
          ...
          onBannerChange={(imageUrl) => {
            if (onCampaignChange && campaign) {
              onCampaignChange({
                ...
                articleConfig: {
                  ...articleConfig,
                  banner: { ...articleConfig.banner, imageUrl },
                },
              });
            }
          }}
          onBannerRemove={() => {
            if (onCampaignChange && campaign) {
              onCampaignChange({
                ...
                articleConfig: {
                  ...articleConfig,
                  banner: { ...articleConfig.banner, imageUrl: undefined },
                },
              });
            }
          }}
          onTitleChange={(title) => {
            if (onCampaignChange && campaign) {
              onCampaignChange({
                ...
                articleConfig: {
                  ...articleConfig,
                  content: { ...articleConfig.content, title },
                },
              });
            }
          }}
          onDescriptionChange={(description) => {
            if (onCampaignChange && campaign) {
              onCampaignChange({
                ...
                articleConfig: {
                  ...articleConfig,
                  content: { ...articleConfig.content, description },
                },
              });
            }
          }}
          ...
          editable={!readOnly}
          maxWidth={810}
          campaignType={campaign?.type || 'jackpot'}
        />
      </div>
    );
  }
