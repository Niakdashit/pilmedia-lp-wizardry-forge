  ...
  return (
    ...
    >
      ...
      <div className={`
        ...
        ${isSelected 
          ? 'bg-gradient-to-br from-[#E0004D] to-[#4D2388] shadow-2xl shadow-[#E0004D]/50' 
      ...
      {isSelected && (
        <div className="absolute inset-0 rounded-3xl border-2 border-[#E0004D]"></div>
      )}
      ...
      {isSelected && (
        <>
          <div className="absolute -top-2 -right-2 w-3 h-3 bg-gradient-to-br from-[#E0004D] to-[#6B2AA0] rounded-full"></div>
