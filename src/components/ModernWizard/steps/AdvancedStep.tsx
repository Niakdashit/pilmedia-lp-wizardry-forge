    ...
    <div className="space-y-6">
      ...
      <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-gray-100/50">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex space-x-3">
                  <button className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-gray-700 text-sm hover:bg-[#E0004D] hover:text-white">Arrondies</button>
                  <button className="px-4 py-2 bg-gray-50 border border-gray-200 rounded text-gray-700 text-sm hover:bg-[#E0004D] hover:text-white">Droites</button>
                  <button className="px-4 py-2 bg-gray-50 border border-gray-200 text-gray-700 text-sm hover:bg-[#E0004D] hover:text-white">Très arrondies</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex justify-between">
          <button
            onClick={prevStep}
            className="px-6 py-3 bg-gray-100 text-gray-700 font-semibold rounded-xl hover:bg-[#E0004D] hover:text-white transition-colors"
          >
            Retour
          </button>
          <button
