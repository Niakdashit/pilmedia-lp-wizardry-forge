          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex space-x-3">
                  <button className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-gray-700 text-sm hover:bg-[#d4dbe8] hover:text-white">Arrondies</button>
                  <button className="px-4 py-2 bg-gray-50 border border-gray-200 rounded text-gray-700 text-sm hover:bg-[#d4dbe8] hover:text-white">Droites</button>
                  <button className="px-4 py-2 bg-gray-50 border border-gray-200 text-gray-700 text-sm hover:bg-[#d4dbe8] hover:text-white">Très arrondies</button>
                </div>
              </div>
            </div>
          </div>
