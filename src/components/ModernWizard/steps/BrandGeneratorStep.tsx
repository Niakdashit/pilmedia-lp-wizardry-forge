    ...
    <div className="space-y-8">
      <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-gray-100/50">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-gradient-to-r from-[#E0004D] to-[#4D2388] rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            ...
            className="flex-1 px-8 py-4 bg-gradient-to-r from-[#E0004D] to-[#4D2388] text-white rounded-xl hover:shadow-lg transition-all duration-300 font-medium flex items-center justify-center gap-2"
          >
        ...
        <div className="flex justify-between mt-8 pt-6 border-t border-gray-200">
          <button
            onClick={onPrev}
            className="px-6 py-3 bg-gray-100 text-gray-700 font-semibold rounded-xl hover:bg-[#E0004D] hover:text-white transition-colors flex items-center gap-2"
          >
