        ...
        <div className="flex flex-col gap-4">
          <div className="relative">
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#E0004D] text-sm sm:text-base"
              value={searchTerm}
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
              <select
                className="border border-gray-300 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-[#E0004D] text-sm bg-white min-w-0 flex-1 sm:flex-none"
                value={filterType}
