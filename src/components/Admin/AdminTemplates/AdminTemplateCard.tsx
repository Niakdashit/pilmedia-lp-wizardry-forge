        ...
        <div className={`relative overflow-hidden ${TEMPLATE_TILE_HEIGHT_CLASS} ${TEMPLATE_TILE_RADIUS_CLASS} bg-gray-100`}>
          ...
          {onUse && (
            <button
              ...
              className="absolute bottom-2 right-2 px-2.5 py-1.5 text-xs sm:text-sm bg-[radial-gradient(circle_at_0%_0%,_#E0004D,_#6B2AA0)] text-white rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"
            >
              Utiliser
            </button>
          )}
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 ml-2">
            {onUse && (
              <button
                onClick={() => onUse(template)}
                className="px-2.5 py-1.5 text-xs sm:text-sm bg-[radial-gradient(circle_at_0%_0%,_#E0004D,_#6B2AA0)] text-white rounded-lg hover:opacity-95 transition-colors"
              >
                Utiliser ce modèle
              </button>
            )}
