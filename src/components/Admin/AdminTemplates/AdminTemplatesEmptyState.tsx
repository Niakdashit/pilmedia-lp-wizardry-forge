...
const AdminTemplatesEmptyState: React.FC = () => {
  return (
    <div className="text-center py-12">
      ...
      <button className="inline-flex items-center px-6 py-3 bg-gradient-to-br from-[#44444d] to-[#44444d] text-white font-semibold rounded-xl hover:bg-[#5a5a63] transition-colors">
