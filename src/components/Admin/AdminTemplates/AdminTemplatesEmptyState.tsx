...
const AdminTemplatesEmptyState: React.FC = () => {
  return (
    <div className="text-center py-12">
      ...
      <button className="inline-flex items-center px-6 py-3 bg-gradient-to-br from-[#E0004D] to-[#6B2AA0] text-white font-semibold rounded-xl hover:bg-[#4D2388] transition-colors">
