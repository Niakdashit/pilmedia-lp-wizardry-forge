...
const BackgroundPanel: React.FC<BackgroundPanelProps> = ({ 
  ...
  // WebEditor: Un seul écran, pas besoin de applyToAllScreens
  ...
  // WebEditor: Fonction handleApplyToAllScreensChange supprimée (un seul écran)
    ...
    if (isTextSelected && onElementUpdate) {
      ...
      onBackgroundChange(
        { type: 'color', value: color },
        {
          ...
          applyToAllScreens: false, // WebEditor: toujours false (un seul écran)
    ...
    <div className="p-4 space-y-6">
      ...
      {activeSubTab === 'style' && !isTextSelected && (
        <div className="space-y-3">
          ...
          {/* WebEditor: Un seul écran, pas besoin de checkbox "Appliquer à tous les écrans" */}
        </div>
      )}
                ...
                return (
                  <button
                    ...
                    className={`p-3 border rounded text-left transition-colors group ${
                      isActiveFont
                        ? 'border-[hsl(var(--primary))] bg-[#44444d] text-white'
                        : 'border-gray-200 hover:border-[hsl(var(--primary))] hover:bg-[#44444d] hover:text-white'
                    }`}
                  >
                ...
                <React.Fragment key={effect.id}>
                  <button
                    ...
                    className={`w-full p-3 border rounded-lg text-left transition-all duration-200 ${
                      isActive
                        ? 'border-[hsl(var(--primary))] bg-[#44444d] text-white shadow-lg'
