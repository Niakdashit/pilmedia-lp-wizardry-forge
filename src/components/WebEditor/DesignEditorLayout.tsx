...
import BurgerKingApp from './components/BurgerKingApp';
...
const handleSaveCampaignName = useCallback(async () => {
  ...
  // WebEditor: Un seul écran (screen1 uniquement)
  const currentScreen = 'screen1';
  ...
  // Handler utilisé par HybridSidebar → BackgroundPanel
  const handleBackgroundChange = useCallback((
    background: { type: 'color' | 'image'; value: string },
    options?: { screenId?: 'screen1'; applyToAllScreens?: boolean; device?: 'desktop' | 'tablet' | 'mobile' }
  ) => {
    const targetScreen = 'screen1';
  ...
  // WebEditor: Pas de bouton replay automatique (un seul écran)
  React.useEffect(() => {
    // Désactivé pour WebEditor (un seul écran)
    return;
  ...
  return (
    ...
    >
            ...
            >
              <div className="min-h-full flex flex-col">
                ...
                <div data-screen-anchor="screen1" className="relative">
                  ...
                  {/* WebEditor: Un seul canvas avec BurgerKingApp */}
                  <div className="w-full h-full flex items-center justify-center bg-gray-50">
                    <div 
                      className="mx-auto shadow-2xl transition-all duration-300"
                      style={{
                        width: selectedDevice === 'mobile' ? '375px' : 
                               selectedDevice === 'tablet' ? '768px' : 
                               '100%',
                        maxWidth: selectedDevice === 'desktop' ? '1200px' : undefined
                      }}
                    >
                      <BurgerKingApp />
                    </div>
                ...
                {/* WebEditor: Pas de canvas supplémentaires */}
              </div>
            </div>
      ...
      {/* Full Screen Preview Modal - WebEditor avec BurgerKingApp */}
      ...
      >
        <div className="w-full h-full overflow-hidden bg-white flex items-center justify-center">
          <div 
            ...
            style={{
              width: fullScreenPreviewDevice === 'mobile' ? '375px' : 
                     fullScreenPreviewDevice === 'tablet' ? '768px' : 
                     '100%',
              maxWidth: fullScreenPreviewDevice === 'desktop' ? '1200px' : undefined
            }}
          >
            <BurgerKingApp />
          </div>
