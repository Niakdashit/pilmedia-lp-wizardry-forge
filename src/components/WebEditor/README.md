# WebEditor - Éditeur Web Simple

## 📋 Description

WebEditor est un éditeur simplifié basé sur ReferenceEditor, conçu pour créer des pages web simples avec **un seul écran**.

## 🎯 Objectif

Fournir un éditeur léger et simple pour créer des pages web sans la complexité multi-écrans.
...
- **Un seul écran (screen1)** : Simplifié par rapport à ReferenceEditor
...
### Accès
```
http://localhost:8080/web-editor
```

### Caractéristiques

1. **Un seul écran** : Simplifié, pas de screen2 ou screen3
2. **Pas de navigation multi-écrans** : Focus sur une seule page
3. **Léger et rapide** : Moins de complexité que les autres éditeurs
...
- ✅ **Screen1 uniquement** : Canvas d'édition classique (texte, images, formes)
...
- ❌ **Pas de multi-écrans** : Un seul écran pour simplifier
...
**Objectif** : Éditeur web simple avec un seul écran
