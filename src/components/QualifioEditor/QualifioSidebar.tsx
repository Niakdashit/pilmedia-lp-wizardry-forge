        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`w-full px-4 py-3 text-left flex items-center space-x-3 border-b border-gray-100 hover:bg-gray-50 transition-colors ${
                isActive ? 'bg-orange-50 border-l-4 border-l-orange-500' : ''
              }`}
            >
              <IconComponent className={`w-5 h-5 ${isActive ? 'text-orange-600' : 'text-gray-400'}`} />
