...
const FormTab: React.FC<FormTabProps> = ({ config, onConfigUpdate }) => {
  ...
  const updateField = (fieldId: string, updates: Partial<FormField>) => {
    ...
    onConfigUpdate({ formFields: updatedFields });
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="premium-card">
        ...
        {formFields.length === 0 ? (
          <div className="text-center py-8 text-sidebar-text-muted">
          ...
          <div className="space-y-4">
            {formFields.map((field) => (
              <div key={field.id} className="border border-sidebar-border rounded-lg p-4 bg-sidebar-surface/50">
                          ...
                          {(field.options || []).map((option, optionIndex) => (
                            <div key={optionIndex} className="flex items-center gap-2">
                              <input
                                ...
                                className="flex-1 px-2 py-1 text-sm border border-sidebar-border rounded"
                              />
                              <button
                ...
                <div key={field.id} className="space-y-1">
                  ...
                  {field.type === 'textarea' ? (
                    <textarea
                      ...
                      className="w-full px-3 py-2 text-sm border border-sidebar-border rounded-md bg-background"
                      rows={3}
                      disabled
                    />
                  ) : field.type === 'select' ? (
