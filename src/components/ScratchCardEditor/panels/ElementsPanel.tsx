  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div>
        ...
        <button
          onClick={addWheel}
          className="w-full p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-[hsl(var(--primary))] hover:bg-[radial-gradient(circle_at_0%_0%,_#d4dbe8,_#b41b60)] hover:text-white transition-colors flex flex-col items-center group"
        >
          ...
          {shapes.map((shape) => {
            ...
            return (
              <button
                ...
                className="p-3 border border-gray-200 rounded-lg hover:border-[hsl(var(--primary))] hover:bg-[radial-gradient(circle_at_0%_0%,_#d4dbe8,_#b41b60)] hover:text-white transition-colors group"
                title={shape.name}
              >
        ...
        <div className="space-y-2">
          {lines.map((line) => (
            <button
              ...
              className="w-full p-3 border border-gray-200 rounded-lg hover:border-[hsl(var(--primary))] hover:bg-[radial-gradient(circle_at_0%_0%,_#d4dbe8,_#b41b60)] hover:text-white transition-colors text-left text-sm"
            >
              {line.name}
            </button>
          ))}
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <button className="p-4 border border-gray-200 rounded-lg hover:border-[hsl(var(--primary))] hover:bg-[radial-gradient(circle_at_0%_0%,_#d4dbe8,_#b41b60)] hover:text-white transition-colors">
