    ...
    <div className="p-4 space-y-6">
        ...
        <div className="space-y-2">
          {lines.map((line) => (
            <button
              ...
              className="w-full p-3 border border-gray-200 rounded-lg hover:border-[hsl(var(--primary))] hover:bg-[radial-gradient(circle_at_0%_0%,_#E0004D,_#6B2AA0)] hover:text-white transition-colors text-left text-sm"
            >
              {line.name}
            </button>
          ))}
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <button className="p-4 border border-gray-200 rounded-lg hover:border-[hsl(var(--primary))] hover:bg-[radial-gradient(circle_at_0%_0%,_#E0004D,_#6B2AA0)] hover:text-white transition-colors">
