      ...
      <div className="flex border-b border-gray-200">
        <button
          ...
          className={`flex-1 px-4 py-3 text-sm font-medium transition-colors ${
            activeTab === 'organiser'
              ? 'text-[#E0004D] border-b-2 border-[#E0004D] bg-purple-50'
          ...
          <>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  onClick={moveToFront}
                  className="flex items-center justify-center space-x-2 p-3 border border-gray-200 hover:border-[#E0004D] hover:bg-[radial-gradient(circle_at_0%_0%,_#E0004D,_#6B2AA0)] hover:text-white rounded-lg transition-all duration-200"
                >
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:border-[#E0004D] focus:ring-1 focus:ring-[#E0004D] transition-colors"
                      placeholder="0"
                    />
                  </div>
                  <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:border-[#E0004D] focus:ring-1 focus:ring-[#E0004D] transition-colors"
                    placeholder="0"
                    min="-180"
                    max="180"
                  />
