  ...
  return (
    <DndProvider backend={HTML5Backend}>
      <MobileResponsiveLayout
        ...
        className={`design-canvas-container flex-1 flex flex-col items-center justify-start ${readOnly ? '' : (isWindowMobile ? '-mt-20' : 'pt-40')} ${readOnly ? '' : 'pb-4 px-4'} ${containerClassName ? containerClassName : 'bg-gray-100'} relative`}
