...
const BrandAssetsCard: React.FC<BrandAssetsCardProps> = ({ campaign, setCampaign }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-[#d4dbe8]/5 to-[#6d164f]/5 rounded-xl p-6 border border-[#d4dbe8]/10">
      <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
        <Palette className="w-5 h-5 mr-2 text-[#d4dbe8]" />
        Identité de marque
      </h3>
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Logo {isExtracting && <span className="text-[#d4dbe8]">(Extraction en cours...)</span>}
          </label>
          <div 
            className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-[#d4dbe8] transition-colors cursor-pointer relative overflow-hidden"
            onDrop={handleDrop}
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <input
                ...
                className="flex-1 px-3 py-2 bg-white/50 border-0 rounded-lg focus:ring-2 focus:ring-[#d4dbe8]"
              />
            </div>
          </div>
