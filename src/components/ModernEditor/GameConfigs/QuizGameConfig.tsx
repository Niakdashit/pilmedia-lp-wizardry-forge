    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={addQuestion}
            className="flex items-center space-x-1 px-3 py-1 text-sm bg-gradient-to-br from-[#E0004D] to-[#6B2AA0] text-white rounded-lg hover:bg-[#4D2388] transition-colors"
          >
          ...
          {questions.map((question: any, questionIndex: number) => (
            <div key={question.id} className="p-4 border border-gray-200 rounded-lg space-y-3">
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm border border-gray-300 rounded focus:ring-1 focus:ring-[#E0004D] focus:border-transparent"
              />
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-xs text-[#E0004D] hover:text-[#4D2388]"
                  >
                    + Ajouter option
                  </button>
                </div>
                ...
                {question.options?.map((option: any, optionIndex: number) => (
                  <div key={option.id} className="flex items-center space-x-2">
                    ...
                    <input
                      ...
                      className="flex-1 px-2 py-1 text-xs border border-gray-300 rounded focus:ring-1 focus:ring-[#E0004D] focus:border-transparent"
                    />
