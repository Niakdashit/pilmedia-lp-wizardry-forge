  ...
  return (
    <div className="space-y-4 h-full overflow-y-auto p-4">
      ...
      <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200 p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          {segments.length > 0 && (
            <div className="text-xs text-gray-600">
              <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-700 mr-1">
        ...
        {segments.length === 0 && (
          <div className="text-center py-6 border-2 border-dashed border-gray-300 rounded-lg mt-3">
            <div className="text-gray-400 mb-2">
              <Palette className="w-6 h-6 mx-auto" />
            </div>
            <p className="text-xs text-gray-500 mb-3">Aucun segment configuré</p>
            <button
              onClick={addSegmentPair}
              className="px-3 py-1 text-xs bg-gradient-to-r from-[#841b60] to-[#6d164f] text-white rounded-md hover:opacity-90 transition-opacity"
            >
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex space-x-1">
              <button
                onClick={addSegmentPair}
                className="flex items-center space-x-1 px-2 py-1 text-xs bg-[#841b60] text-white rounded-md hover:bg-[#6d164f] transition-colors"
              >
              ...
              {segments.length >= 2 && (
                <button
                  ...
                  className="flex items-center space-x-1 px-2 py-1 text-xs bg-red-500 text-white rounded-md hover:bg-red-600 transition-colors"
                >
          ...
          <div className="space-y-2 max-h-48 overflow-y-auto">
            {segments.map((segment: any, index: number) => {
              ...
              return (
                <div key={segment.id || index} className={`flex items-center space-x-2 p-2 border rounded-md transition-colors ${
