      ...
      <div className="flex items-center justify-between">
        ...
        {cards.length < maxCards && (
          <button
            type="button"
            onClick={onAddCard}
            className="text-sm text-[#E0004D] hover:text-[#4D2388] flex items-center"
          >
        ...
        <div key={card.id} className="border border-gray-200 rounded-lg p-4 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#E0004D]"
