      ...
      <div className="space-y-8">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 mb-2 flex items-center">
            <Type className="w-6 h-6 mr-2 text-[#d4dbe8]" />
            Textes et messages
          </h2>
            ...
            return (
              <button
                ...
                className={`flex-1 flex items-center justify-center space-x-2 px-4 py-3 rounded-lg transition-all ${
                  activeScreen === key
                    ? 'bg-white shadow-sm text-[#d4dbe8] font-medium'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#d4dbe8] focus:border-transparent"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#d4dbe8] focus:border-transparent resize-none"
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-6 space-y-4">
                ...
                {activeScreen !== 'game' && (
                  <button className="px-6 py-2 bg-gradient-to-br from-[#d4dbe8] to-[#b41b60] text-white rounded-lg font-medium">
