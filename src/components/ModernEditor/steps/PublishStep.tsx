      ...
      <div className="space-y-8">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 mb-2 flex items-center">
            <Share2 className="w-6 h-6 mr-2 text-[#E0004D]" />
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-[#E0004D] to-[#4D2388] text-white rounded-xl hover:shadow-lg transition-all duration-300 font-semibold text-lg disabled:opacity-50"
              >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <div className="flex space-x-2">
                ...
                <button className="px-4 py-2 bg-gradient-to-br from-[#E0004D] to-[#6B2AA0] text-white rounded-lg hover:bg-[#4D2388] transition-colors">
