...
const ExportPanel: React.FC = () => {
  ...
  const renderPreview = () => (
    <div className="space-y-4">
      ...
      <button className="w-full flex items-center justify-center space-x-2 py-3 bg-[#44444d] text-white rounded-lg hover:bg-[#44444d] transition-colors">
  ...
  const renderPublish = () => (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <button className="flex items-center justify-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-[hsl(var(--primary))] hover:bg-[#44444d] hover:text-white transition-colors group">
      ...
      <div className="bg-gray-50 rounded-lg p-4">
        ...
        <div className="space-y-2">
          {exportFormats.map((format) => (
            <button
              key={format.id}
              className="w-full flex items-center justify-between p-3 bg-white border border-gray-200 rounded-lg hover:border-[hsl(var(--primary))] hover:bg-[#44444d] hover:text-white transition-colors group"
            >
