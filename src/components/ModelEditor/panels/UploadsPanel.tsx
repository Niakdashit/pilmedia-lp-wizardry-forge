  ...
  return (
    <div className="p-4 space-y-6">
        ...
        <button
          ...
          className={`w-full p-6 border-2 border-dashed rounded-lg transition-colors group ${
            dragOver 
              ...
              : 'border-gray-300 hover:border-[hsl(var(--primary))] hover:bg-[#44444d] hover:text-white'
          }`}
        >
      ...
      <div>
        ...
        <button className="w-full p-3 text-left border border-gray-200 rounded-lg hover:border-[hsl(var(--primary))] hover:bg-[#44444d] hover:text-white transition-colors group">
