  ...
  return (
    <div className="p-4 space-y-6">
        ...
        <button
          ...
          className={`w-full p-6 border-2 border-dashed rounded-lg transition-colors group ${
            dragOver 
              ...
              : 'border-gray-300 hover:border-[hsl(var(--primary))] hover:bg-[radial-gradient(circle_at_0%_0%,_#d4dbe8,_#b41b60)] hover:text-white'
          }`}
        >
      ...
      <div>
        ...
        <button className="w-full p-3 text-left border border-gray-200 rounded-lg hover:border-[hsl(var(--primary))] hover:bg-[radial-gradient(circle_at_0%_0%,_#d4dbe8,_#b41b60)] hover:text-white transition-colors group">
