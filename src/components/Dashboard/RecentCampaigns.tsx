        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          return <div key={campaign.id} className="group relative overflow-hidden rounded-[18px] shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-[1.02]">
                ...
                <div className="relative h-64 w-full overflow-hidden bg-gradient-to-br from-gray-900 to-gray-700">
                  ...
                  <div className="absolute inset-0 rounded-[18px] border border-white/20 group-hover:border-[#E0004D]/50 group-hover:shadow-[0_0_30px_rgba(132,27,96,0.3)] transition-all duration-500"></div>

                  {/* Campaign Type Badge */}
                  <div className="absolute top-4 left-4 z-20">
                    <div className="group/badge relative overflow-hidden rounded-full bg-white/95 backdrop-blur-sm text-[#E0004D] px-3 py-1.5 text-xs font-bold shadow-lg border border-white/50 hover:bg-white transition-all duration-300">
                      ...
                      {/* Badge Glow Effect */}
                      <div className="absolute inset-0 bg-gradient-to-r from-[#E0004D]/20 to-transparent opacity-0 group-hover/badge:opacity-100 transition-opacity duration-300 rounded-full"></div>
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 z-10">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#E0004D]/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-b-[18px]"></div>
                  </div>
