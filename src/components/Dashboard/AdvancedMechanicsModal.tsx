        ...
        <div className="p-5 grid grid-cols-2 gap-4">
          {items.map((item) => (
            <button
              ...
              className="group flex flex-col items-center justify-center gap-3 p-4 rounded-xl border border-gray-200 hover:border-[#44444d]/50 hover:shadow transition-all"
            >
              ...
              <span className="text-sm font-medium text-gray-800 group-hover:text-[#44444d]">{item.label}</span>
            </button>
          ))}
        </div>
