          ...
          <div className="px-5 py-4">
            <div className="space-y-3">
              ...
              <button
                ...
                className="group flex items-center gap-4 rounded-xl border border-gray-200/80 bg-white hover:border-[#E0004D] hover:shadow-lg transition-all text-left p-3"
              >
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <h3 className="text-base font-semibold text-gray-900 group-hover:text-[#E0004D] transition-colors">
                      Full Screen
                    </h3>
              ...
              <button
                ...
                className="group flex items-center gap-4 rounded-xl border border-purple-200/80 bg-white hover:border-[#E0004D] hover:shadow-lg transition-all text-left p-3"
              >
                <div className="relative flex-shrink-0 h-16 w-24 rounded-lg overflow-hidden bg-gradient-to-br from-[#fdf6ff] via-[#f6f7ff] to-[#ffeef5] flex items-center justify-center">
                  {/* Icon image (optional). If missing, the gradient box remains as fallback */}
                  <img
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-2 py-0.5 text-[10px] font-medium rounded-full bg-[#E0004D]/10 text-[#E0004D]">
                      Guidé
                    </span>
                  </div>
                  <p className="text-sm text-gray-600 leading-snug">
