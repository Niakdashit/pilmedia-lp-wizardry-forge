        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              <div className="w-20 h-20 bg-gradient-to-r from-[#E0004D] via-purple-600 to-indigo-600 rounded-full flex items-center justify-center mx-auto mb-6 relative">
                <Sparkles className="w-10 h-10 text-white" />
                <div className="absolute inset-0 bg-gradient-to-r from-[#E0004D] via-purple-600 to-indigo-600 rounded-full animate-pulse opacity-50"></div>
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#E0004D] focus:border-transparent transition-all"
                  />
                </div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={!url}
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-[#E0004D] via-purple-600 to-indigo-600 text-white rounded-lg hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 font-medium flex items-center justify-center gap-2"
                >
        ...
        return (
          <div className="text-center py-16">
            <div className="relative mb-8">
              <Loader2 className="w-16 h-16 text-[#E0004D] animate-spin mx-auto" />
            ...
            <div className="space-y-3 text-gray-600 max-w-md mx-auto">
              <div className="flex items-center justify-center gap-2 animate-pulse">
                <div className="w-2 h-2 bg-gradient-to-br from-[#E0004D] to-[#6B2AA0] rounded-full"></div>
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={handleApply}
                className="flex-1 px-6 py-3 bg-gradient-to-r from-[#E0004D] via-purple-600 to-indigo-600 text-white rounded-lg hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 font-medium"
              >
