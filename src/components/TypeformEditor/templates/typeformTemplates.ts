...
export const typeformTemplates: TypeformTemplate[] = [
  {
    ...
    description: 'Premium feedback survey with advanced features',
    category: 'feedback',
    ...
    questions: [
      ...
      },
      {
        ...
        required: false,
        options: ['Quality', 'Speed', 'Customer Support', 'Price', 'Ease of use'],
        layout: 'cards-grid',
        panelBackgroundColor: '#4E211D',
        fontFamily: 'DM Sans',
        fontSize: 'large',
      ...
      },
      {
        ...
        description: 'Your input helps us improve every day',
        required: false,
        placeholder: '',
        layout: 'centered-card',
        backgroundType: 'color',
