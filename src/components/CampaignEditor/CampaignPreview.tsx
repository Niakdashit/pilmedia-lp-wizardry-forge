        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className={`px-3 py-1 text-sm rounded ${previewDevice === 'desktop' ? 'bg-gradient-to-br from-[#841b60] to-[#b41b60] text-white' : 'bg-white text-gray-600 border'}`}
            >
              Desktop
            </button>
            <button
              onClick={() => setPreviewDevice('tablet')}
              className={`px-3 py-1 text-sm rounded ${previewDevice === 'tablet' ? 'bg-gradient-to-br from-[#841b60] to-[#b41b60] text-white' : 'bg-white text-gray-600 border'}`}
            >
              Tablet
            </button>
          </div>
