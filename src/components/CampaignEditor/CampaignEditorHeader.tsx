    ...
    <div className="flex justify-between items-center mb-4">
      ...
      <div className="flex space-x-3">
        ...
        <button
          ...
          className="inline-flex items-center px-3 py-1.5 bg-brand-gradient text-white text-sm font-medium rounded-lg hover:bg-[#6d164f] transition-colors duration-200"
        >
          Publier
