        ...
        {showFunnel ? (
          ...
          <div className="group fixed inset-0 z-40 w-full h-[100dvh] min-h-[100dvh] overflow-hidden bg-transparent flex">
            ...
            <button
              ...
              className={`absolute top-4 ${previewButtonSide === 'left' ? 'left-4' : 'right-4'} z-50 px-4 py-2 bg-[radial-gradient(circle_at_0%_0%,_#841b60,_#b41b60)] text-white rounded-lg opacity-70 hover:opacity-100 transition-opacity duration-300 shadow-lg`}
            >
              Mode édition
            </button>
