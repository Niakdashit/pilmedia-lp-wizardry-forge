...
const ImageModulePanel: React.FC<ImageModulePanelProps> = ({ module, onUpdate }) => {
        ...
        <div className="space-y-8">
          ...
          <section className="space-y-3">
            ...
            <p className="text-xs text-gray-500">
              "Remplir" recadre l'image pour remplir l'espace. "Ajuster" garde l'image complète avec des marges si nécessaire.
            </p>
          </section>
        </div>
      </div>
