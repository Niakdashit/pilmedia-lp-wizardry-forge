...
const HybridSidebar = forwardRef<HybridSidebarRef, HybridSidebarProps>(({
  ...
  if (isCollapsed) {
    return (
      <div data-hybrid-sidebar="collapsed" className="w-16 bg-[hsl(var(--sidebar-bg))] border-r border-[hsl(var(--sidebar-border))] flex flex-col rounded-bl-[28px]" style={themeVars}>
        <button
  ...
  return (
    <div data-hybrid-sidebar="expanded" className="flex h-full min-h-0">
      ...
      {internalActiveTab && (
        <div className="w-80 bg-[hsl(var(--sidebar-bg))] border-r border-[hsl(var(--sidebar-border))] flex flex-col h-full min-h-0 shadow-sm rounded-bl-[28px]">
