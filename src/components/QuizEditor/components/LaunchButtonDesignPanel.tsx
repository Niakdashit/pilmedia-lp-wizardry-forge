...
const DEFAULT_BACKGROUND = 'radial-gradient(circle at 0% 0%, #d4dbe8, #b41b60)';
        ...
        <div className="mt-4 space-y-4">
          <label className="block text-xs font-medium text-gray-700">
            ...
            <input
              ...
              className="mt-1 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#d4dbe8]/40"
            />
          </label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <label className="block text-xs font-medium text-gray-700">
              ...
              <input
                type="color"
                value={backgroundInput.startsWith('#') ? backgroundInput : '#d4dbe8'}
                onChange={(event) => handleBackgroundChange(event.target.value)}
