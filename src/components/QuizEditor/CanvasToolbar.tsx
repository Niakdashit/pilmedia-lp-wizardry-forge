    ...
    <div className="relative" data-canvas-ui="1">
      ...
      <button 
        ...
        className={`p-1 rounded sm:p-1.5 rounded hover:bg-gray-700 transition-colors duration-150 ${
          selectedElement.fontWeight === 'bold' ? 'bg-[#E0004D] text-white' : ''
        }`}
        title="Gras (Ctrl+B)"
      >
      ...
      <button 
        ...
        className={`p-1 rounded sm:p-1.5 hover:bg-gray-700 transition-colors duration-150 ${
          selectedElement.fontStyle === 'italic' ? 'bg-[#E0004D] text-white' : ''
        }`}
      ...
      <button 
        ...
        className={`p-1 rounded sm:p-1.5 hover:bg-gray-700 transition-colors duration-150 ${
          selectedElement.textDecoration === 'underline' ? 'bg-[#E0004D] text-white' : ''
        }`}
      ...
      <div className="relative">
        <button 
          ...
          className="p-1 sm:p-1.5 rounded hover:bg-gray-700 transition-colors duration-150 flex items-center space-x-1 bg-[#E0004D] text-white"
