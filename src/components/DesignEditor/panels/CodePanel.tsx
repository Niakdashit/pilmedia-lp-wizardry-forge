...
.element-button button {
  background: ${campaign?.design?.buttonColor || '#44444d'};
      ...
      <div className="flex-1 overflow-hidden flex flex-col">
        ...
        <div className="p-3 border-t border-gray-700 bg-gray-800 flex items-center justify-between gap-3" style={{ pointerEvents: 'auto', zIndex: 50 }}>
          ...
          <button
            ...
            className="px-4 py-2 bg-[#44444d] text-white text-xs font-medium rounded-lg hover:bg-[#5a5a63] transition-colors"
          >
            Appliquer
          </button>
        </div>
