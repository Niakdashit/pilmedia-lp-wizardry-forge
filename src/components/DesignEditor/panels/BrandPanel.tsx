...
const BrandPanel: React.FC<BrandPanelProps> = ({ onAddElement }) => {
  ...
  return (
    <div className="p-4 space-y-6">
      <div>
        <button className="w-full p-4 bg-[radial-gradient(circle_at_0%_0%,_#E0004D,_#6B2AA0)] text-white rounded-lg hover:bg-[radial-gradient(circle_at_0%_0%,_#E0004D,_#6B2AA0)] transition-colors flex items-center justify-center">
