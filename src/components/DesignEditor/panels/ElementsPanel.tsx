    ...
    <div className="p-4 space-y-6">
          ...
          {shapes.map((shape) => {
            ...
            return (
              <button
                ...
                className="p-3 border border-gray-200 rounded-lg hover:border-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))] hover:text-white transition-colors group"
                title={shape.name}
              >
        ...
        <div className="space-y-2">
          {lines.map((line) => (
            <button
              ...
              className="w-full p-3 border border-gray-200 rounded-lg hover:border-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))] hover:text-white transition-colors text-left text-sm"
            >
              {line.name}
            </button>
          ))}
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <button className="p-4 border border-gray-200 rounded-lg hover:border-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))] hover:text-white transition-colors">
