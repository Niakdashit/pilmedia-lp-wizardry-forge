...
const GameManagementPanel: React.FC<GameManagementPanelProps> = ({
  ...
  const extractedColors = campaign?.design?.extractedColors || [];
  const primaryColor = extractedColors[0] || '#d4dbe8';
      ...
      {activeSection === 'segments' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={addSegment}
              className="flex items-center px-3 py-2 bg-[#d4dbe8] text-white text-sm rounded-lg hover:bg-[#6d1650] transition-colors"
            >
                      ...
                      {segment.contentType === 'text' ? (
                        <>
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-[#d4dbe8] focus:border-transparent"
                          />
                        </>
                      ) : (
                        <>
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <input
                          ...
                          value={segment.color}
                          onChange={(e) => updateSegment(segment.id, { color: e.target.value })}
                          className="flex-1 px-2 py-1 text-xs border border-gray-300 rounded focus:ring-1 focus:ring-[#d4dbe8] max-w-20"
                        />
                      </div>
                    </div>
                  </div>
