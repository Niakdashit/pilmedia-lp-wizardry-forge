    ...
    <div className="p-6 space-y-6 min-h-full overflow-y-auto text-[hsl(var(--sidebar-text-primary))]">
      ...
      <div className="space-y-2">
        ...
        <select
          ...
          className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#E0004D] focus:border-transparent"
        >
