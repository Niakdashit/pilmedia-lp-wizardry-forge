  ...
  return (
    <div className="bg-white border-b border-gray-200 px-4 py-2 flex items-center justify-between shadow-sm rounded-tl-[18px] rounded-tr-[18px]">
      ...
      <div className="flex items-center space-x-1">
        ...
        <button className="flex items-center px-3 py-1.5 text-xs sm:text-sm bg-[radial-gradient(circle_at_0%_0%,_#E0004D,_#6B2AA0)] text-white rounded-lg hover:bg-[radial-gradient(circle_at_0%_0%,_#E0004D,_#6B2AA0)] transition-colors">
