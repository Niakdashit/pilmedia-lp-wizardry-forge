...
const ScaledGamePreview: React.FC<ScaledGamePreviewProps> = ({
  ...
  if (campaign?.type === 'wheel') {
    ...
    return (
      <div 
        ref={containerRef}
        className={selectedDevice === 'desktop' ? "relative w-full h-full flex items-center justify-center" : selectedDevice === 'tablet' ? "relative w-full h-full flex items-start justify-center pt-8 p-4 pb-8" : "relative w-full h-full flex items-center justify-center p-4"}
        style={{
