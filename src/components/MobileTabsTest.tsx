  ...
  return (
    <div ref={containerRef} className="h-screen w-screen bg-gray-100">
      ...
      <div className="bg-white p-4 border-b">
        <h1 className="text-xl font-bold mb-4">Test des onglets mobiles</h1>
      ...
      <div className="flex h-full">
        ...
        {showHybridSidebar && !forceMobileUI && (
          ...
          <div className="text-center">
            ...
            <div className="mt-6 text-left max-w-md">
              ...
              <ol className="text-sm text-gray-600 space-y-1">
                <li>1. Changez l'appareil simulé pour tester différents modes</li>
                <li>2. Sur mobile/tablette, vérifiez la barre d'onglets en bas</li>
                <li>3. Sur desktop, vérifiez la sidebar à gauche</li>
                <li>4. Testez la sélection/désélection d'éléments</li>
                <li>5. Vérifiez que tous les onglets sont visibles</li>
              </ol>
            </div>
          </div>
        </div>
