...
// import SwiperSettingsButton from './components/SwiperSettingsButton';
...
// import { SwiperModuleRenderer } from './SwiperRenderer';
...
const DesignCanvas = React.forwardRef<HTMLDivElement, DesignCanvasProps>(({ 
  ...
  const handleElementUpdate = useCallback((id: string, updates: any) => {
    ...
    if (updates.borderRadius !== undefined && id === 'quiz-template') {
      ...
      // Forcer le re-render du TemplatedSwiper
  ...
  }), [quizCampaignForRenderer, selectedDevice, readOnly, quizLayout]);
          ...
          >
            ...
            >
              ...
              {(() => {
                ...
                console.log('🎯 Campaign object for TemplatedSwiper:', campaignToUse);
                ...
                return (
                  ...
                  >
                    <div className="w-full" style={{ pointerEvents: 'auto' }}>
                      {/* SwiperModuleRenderer désactivé */}
                      {/* <SwiperModuleRenderer
              ...
              {/* Bouton configuration - désactivé pour SwiperEditor */}
            </div>
